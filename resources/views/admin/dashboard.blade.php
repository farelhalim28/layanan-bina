                                    ...
                                    <tbody>
                                        @forelse($warga as $w)
                                            <tr>
                                                ...
                                                <td>{{ $w->pekerjaan }}</td>
                                                <td>
                                                    <a href="{{ route('admin.warga.show', $w->warga_id) }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($jenis->syarat_json)
                                                        <small
                                                            class="text-muted">{{ Str::limit($jenis->syarat_json, 40) }}</small>
                                                    @else
                        ...
                        @forelse($media as $m)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('admin.media.destroy', $m->media_id) }}" method="POST"
